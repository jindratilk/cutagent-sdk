...
import {readCapturedWaveformSources} from "./sdk-waveform-source-custody.js";
    ...
    async runtimeClientFactory({request, authenticated, sdkSessionId, advertisedActionIds, resolveLiveTargets = null, terminalRecovery = false}) {
      ...
      try {
        ...
        async inspectPreparedActionTimeline(payload) {
          ...
          if (operation === "audio.waveform.sources") {
            return readCapturedWaveformSources({request, captured, payload, liveInspectionService});
          }
