...
const operationCreateRequestOptions = [
    ...
    operationControlBase.extend({ operation: z.literal("operation.create"), actionId: z.literal("cutagent.action.timeline.clip_markers.batch"), input: sdkTimelineClipMarkerBatchInputSchema, idempotencyKey: sdkIdempotencyKeySchema }).strict(),
