...
- `--head` (optional, default: `0.0`) — Move the start inward in seconds; negative extends it
- `--tail` (optional, default: `0.0`) — Move the end inward in seconds; negative extends it
