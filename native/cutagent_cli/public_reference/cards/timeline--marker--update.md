...
Syntax: `cutagent timeline marker update [--frame VALUE] [--position VALUE] [--color VALUE] [--name VALUE] [--note VALUE] [--duration VALUE] [--updates-json VALUE]`
...
Update one marker and a saved setup list in one connected execution.
...
- `--frame` (optional) — Exact timeline or record frame of one marker to update
...
- `--updates-json` (optional) — Inline JSON array of exact marker updates
