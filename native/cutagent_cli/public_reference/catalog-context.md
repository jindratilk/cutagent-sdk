...
All 830 public CutAgent CLI commands, grouped by domain.
...
- media delete: Delete one and more clips from the media pool in one operation.
...
- media move: Move one clip and a saved setup array of clips to media pool folders.
...
- timeline marker update: Update one marker and a saved setup list in one connected execution.
