    ...
    if command_id == "edit.transition.batch":
        ...
        for index, transition in enumerate(transitions):
            ...
            if transition.get("kind") == "clip_edges":
                primary = transition["target"]
            else:
                primary = transition["outgoing"] if placement == "end" else transition["incoming"]
            entries.append(
                {
                    "index": index,
                    "track_type": "video",
                    ...
                    **({} if transition.get("kind") == "clip_edges" else {"at_frame": transition["editFrame"]}),
